...
**React Native Notifree** recover the Local Notification API from [React Native Firebase 5](), allowing projects that use React Native Firebase to continue running without the need to purchase extra licenses. 
...
```bash
react-native link react-native-notifree
```
